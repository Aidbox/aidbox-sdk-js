...
export interface SubstanceSourceMaterialHybrid extends BackboneElement {
...
export interface SubstanceSourceMaterialOrganismGeneral extends BackboneElement {
...
export interface SubstanceSourceMaterialAuthor extends BackboneElement {
