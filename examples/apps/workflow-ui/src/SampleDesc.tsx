   ...
   return (
     <Card css={{ mt: '20px' }}>
       <Card.Body css={{ width: 'auto' }} >
         ...
         >
           ...
           >
             ...
             >
               {appointmentId &&
                 <Text
                   css={{ 'text-align': 'center', 'mt': 0, 'my': 0 }}
                 >
        ...
        &nbsp;
                   <Text css={{ my: 0 }}>{prettifyDate(appointmentData?.start || '')}</Text>
                 </Grid>
                 <Grid
                   xs={12}
                   alignItems='center'
        ...
        &nbsp;
                   <Text css={{ my: 0 }}>{appointmentData?.description || ''}</Text>
                 </Grid>
               </Grid.Container>
