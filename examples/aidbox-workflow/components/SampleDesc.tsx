...
import { AppointmentInfo } from '../../aidbox-subscription/frontend/update-sample'
           ...
           >
               ...
               >
                 ...
                 <Text css={{ 'max-width': '80%', 'pl': '10px' }}>
                   <Link
                     ...
                     target='_blank'
                   >Appointment trigger</Link>
                  &nbsp;that starts the workflow on the&nbsp;appointment&#8288;-&#8288;creating event.</Text>
               </Grid>
               <Grid
                 xs={12}
                 alignItems='center'
             ...
             <Text css={{ 'max-width': '80%' }}>And created&nbsp;
               <Link
                 ...
                 target='_blank'
               >business logic</Link> to send patient an email notifications two days before an appointment.</Text>
           </Grid>
           <Grid
             xs={6}
             md={6}
