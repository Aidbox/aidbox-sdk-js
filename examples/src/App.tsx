...
const sampleCardsInfo = [
  {
    ...
    readmeLink: 'https://github.com/Aidbox/aidbox-sdk-js/tree/main/examples/aidbox-subscription/README.md'
  }, {
    title: 'Aidbox Workflow Engine',
    body: 'Lorum Ipsum',
    sampleLink: '/workflow-engine',
    readmeLink: ''
  }
]
