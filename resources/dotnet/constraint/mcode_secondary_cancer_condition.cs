...
public class McodeSecondaryCancerCondition
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-secondary-cancer-condition"] };
