...
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/StructureDefinition/hdlcholesterol"] };
	public Base.CodeableConcept[]? Category { get; set; }
	public required Observation_ReferenceRange[] ReferenceRange { get; set; }
