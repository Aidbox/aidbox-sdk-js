...
public class McodeCancerRelatedMedicationRequest
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-related-medication-request"] };
