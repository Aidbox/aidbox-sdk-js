...
public class McodeComorbiditiesElixhauser
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-comorbidities-elixhauser"] };
