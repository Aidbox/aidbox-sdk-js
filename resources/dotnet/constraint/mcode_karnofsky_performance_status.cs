...
public class McodeKarnofskyPerformanceStatus
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-karnofsky-performance-status"] };
