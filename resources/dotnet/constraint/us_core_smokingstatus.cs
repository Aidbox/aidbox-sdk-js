...
public class UsCoreSmokingstatus
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-smokingstatus"] };
	...
	public required string EffectiveDateTime { get; set; }
	public required string Status { get; set; }
	public required Base.CodeableConcept Code { get; set; }
	public Base.Identifier[]? Identifier { get; set; }
	public string? EffectiveTiming { get; set; }
	public required Base.CodeableConcept ValueCodeableConcept { get; set; }
