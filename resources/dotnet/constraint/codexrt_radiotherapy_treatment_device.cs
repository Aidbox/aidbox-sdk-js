...
public class CodexrtRadiotherapyTreatmentDevice
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/codex-radiation-therapy/StructureDefinition/codexrt-radiotherapy-treatment-device"] };
	...
	public required Device_DeviceName[] DeviceName { get; set; }
