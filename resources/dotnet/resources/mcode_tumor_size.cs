...
public class McodeTumorSize
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tumor-size"] };
	...
	public required Observation_Component[] Component { get; set; }
