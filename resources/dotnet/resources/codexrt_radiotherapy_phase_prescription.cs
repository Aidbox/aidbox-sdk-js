...
public class CodexrtRadiotherapyPhasePrescription
{
	public Meta Meta { get; } = new() { Profile = ["http://hl7.org/fhir/us/codex-radiation-therapy/StructureDefinition/codexrt-radiotherapy-phase-prescription"] };
	...
	public required Base.Extension[] Extension { get; set; }
